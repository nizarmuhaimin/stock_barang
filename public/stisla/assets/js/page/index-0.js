...
var dataFromAttribute = JSON.parse(
    canvasElement.getAttribute("data-statistic")
);
var statistics_chart = canvasElement.getContext("2d");
var dataLabels = JSON.parse(canvasElement.getAttribute("data-labels"));
